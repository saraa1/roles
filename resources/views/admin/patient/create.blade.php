                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header card-header-danger">
                            ...
                            <p class="card-category">Complete patient profile</p>
                        </div>
                        <div class="card-body">

                            {!! Form::open(['method'=>'POST','action'=>['AdminPatientController@store'],'files'=>true]) !!}
                            ...
                            <div class="form-group">
                                {!! Form::submit('Add Patient ',['class'=>'btn btn-primary pull-right']) !!}
                            </div>
