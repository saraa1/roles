...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div><h1 class="text-danger"><center><b>Welcome to Admin Psychiatrist Panel</b></center></h1></div>
            <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-13">
                    <a href="{{route('admin.psychiatrist.index')}}">
                        ...
                        <div class="card card-chart" >
                            ...
                            <div class="card-body">
                                <h4 class="card-title">
                                    You can view all the records of psychiatrists as well as add new records for them.
                                </h4>
